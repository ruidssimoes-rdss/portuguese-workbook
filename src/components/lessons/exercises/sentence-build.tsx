          ...
          <div className="flex flex-wrap gap-2">
            {placed.map((word, i) => (
              <button
                ...
                disabled={submitted}
                className={`px-3 py-2 rounded-[10px] text-[14px] font-medium transition-all duration-150 ${
                  submitted
                    ? result?.correct
                      ? "border border-[#059669] bg-[#F0FDF4] text-[#059669]"
                      : "border border-[#DC2626] bg-[#FEF2F2] text-[#DC2626]"
                    : "bg-[rgba(0,51,153,0.05)] border border-[#003399] text-[#003399] cursor-pointer hover:bg-[#003399] hover:text-white active:scale-95"
                }`}
              >
                {word}
              </button>
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {available.map((word, i) => (
            <button
              ...
              className="px-3 py-2 rounded-[10px] border border-[var(--border-primary)] text-[14px] font-medium text-[var(--text-primary)] hover:border-[#003399] hover:bg-[rgba(0,51,153,0.05)] cursor-pointer transition-all duration-150 active:scale-95"
            >
              {word}
            </button>
          ))}
