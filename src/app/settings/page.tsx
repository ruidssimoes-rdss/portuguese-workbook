            ...
            <div className="rounded-lg border border-gray-200 bg-white p-4 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-gray-200 px-4 py-3 text-base focus:ring-2 focus:ring-[#5B4FA0] focus:border-[#5B4FA0] outline-none"
                />
              </div>
              <div>
              ...
              <button
                ...
                onClick={saveProfile}
                disabled={saving}
                className="rounded-lg bg-[#5B4FA0] px-4 py-2 text-white text-sm font-medium hover:bg-[#4a4190] disabled:opacity-60"
              >
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 shrink-0 rounded-full border transition-colors ${
                    showPhonetics ? "bg-[#5B4FA0] border-[#5B4FA0]" : "bg-gray-200 border-gray-200"
                  }`}
                >
                  <span
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-4 space-y-3">
              <p>
                <Link
                  ...
                  className="text-[#5B4FA0] text-sm font-medium hover:underline"
                >
