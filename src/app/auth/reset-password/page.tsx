        ...
        <div className="rounded-lg border border-gray-200 bg-white p-8 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-lg bg-[#3C5E95] py-3 text-white font-medium text-[15px] hover:bg-[#4a4190] disabled:opacity-60 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
